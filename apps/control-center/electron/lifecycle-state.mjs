...
export function shouldQuitOnLastWindowClosed({
  ...
  // The hot-switch window is the user's explicit connection boundary. On
  // Windows/Linux, closing it must end the process even when a tray icon exists
  // so the next Codex launch returns to the native model catalog.
