...
repository_url=${CODEX_ROUTER_REPOSITORY_URL:-https://github.com/YIFANGTXX/codex-router-local.git}
...
if [ -z "$repo_dir" ]; then
  ...
  if [ -d "$install_dir/.git" ]; then
    ...
    case "$origin_url" in
      "$repository_url"|https://github.com/YIFANGTXX/codex-router-local|https://github.com/YIFANGTXX/codex-router-local.git|git@github.com:YIFANGTXX/codex-router-local.git)
        ;;
      *)
