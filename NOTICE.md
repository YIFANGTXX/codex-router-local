...
Codex Router Local is maintained and released by
[一方通行](https://github.com/YIFANGTXX). Modified copies and redistributions must
retain this attribution together with the license notices below.

This project is derived from
[duolahypercho/codex-router](https://github.com/duolahypercho/codex-router),
distributed under the MIT License. Copyright (c) 2026 codex-router
contributors.
